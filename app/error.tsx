...
export default function ErrorPage() {
  return (
    <div className="inner flex w-full flex-col items-center justify-center py-12">
      <ErrorSvg />

      <div className="flex flex-col items-center justify-center">
        <p className="md:text-6xl lg:text-7xl mt-8 text-5xl font-bold tracking-wider text-gray-600">
          500
        </p>
        <p className="mt-2 text-2xl font-bold text-gray-600 md:text-3xl lg:text-4xl">
          Server Error
        </p>
        <p className="md:text-lg mt-4 text-gray-500 xl:text-xl">
